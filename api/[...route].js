...
const schemas = {
  ...
  materials: new mongoose.Schema({ _id: String, name: String, sku: String, category: String, unit: String, unitPrice: Number, reorderLevel: Number, sqFtPerUnit: { type: Number, default: 0 }, status: { type: String, default: 'Active' }, createdAt: String }, schemaOptions),
